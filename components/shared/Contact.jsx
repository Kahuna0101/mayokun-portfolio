    ...
    <section id="contact">
      <div className="flex-app">
        <h2 className="head-text">
          Take a cofee{" "}
          <span className="text-secondary-color">and chat with me</span>
        </h2>
        ...
        <div className="flex md:w-[80%] justify-between items-center m-8 flex-wrap">
          <div className="app__footer-card">
            ...
            <Link
              href="mailto:adeniyimayokuno@gmail.com"
              className="p-text font-medium hover:text-black-color"
            >
              adeniyimayokuno@gmail.com
            </Link>
          </div>
          <div className="app__footer-card">
            <PhoneCall className="w-10 h-10 mx-3" />
            <Link
              href="tel:+2348022934137"
              className="p-text font-medium hover:text-black-color"
            >
              +2348022934137
            </Link>
          ...
          <div className="app__footer-card">
            ...
            <Link
              href="https://www.instagram.com/@mayork85"
              target="_blank"
              className="p-text font-medium hover:text-black-color"
            >
              @mayork85
